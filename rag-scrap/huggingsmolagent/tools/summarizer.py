...
def _get_llm():
    # Use OpenRouter by default for cloud deployment
    model = os.getenv("OPEN_AI_MODEL", "meta-llama/llama-3.1-70b-instruct")
    return ChatOpenAI(
        model=model,
        temperature=0.2,
        openai_api_base=os.getenv("BASE_URL", "https://openrouter.ai/api/v1"),
