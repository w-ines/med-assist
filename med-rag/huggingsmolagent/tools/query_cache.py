...
def cache_query_result(ttl: Optional[int] = None):
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            # Compute query hash - remove 'query' from kwargs to avoid duplicate
            hash_kwargs = {k: v for k, v in kwargs.items() if k != 'query'}
            cache_key = compute_query_hash(query, **hash_kwargs)
...
# Global instance of Redis cache (optional)
